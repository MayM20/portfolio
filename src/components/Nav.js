...
listenToScroll = () => {
  ...
  render(){
    ...
    const scrolled = this.state.isTop ? 'navbar navbar-expand-lg navbar-light bg-transparent fixed-top' : 'navbar navbar-expand-lg navbar-light bg-light fixed-top';
    ...
    return(
      <nav onScroll={this.listenToScroll} className={`${scrolled}`}>
        ...
        <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item"><AnchorLink href="#about-me" className="nav-link">About</AnchorLink></li>
            <li className="nav-item"><AnchorLink href="#contact-section" className="nav-link">Contact</AnchorLink></li>
          </ul>
        </div>
        </div>
        </nav>
